...
-(void)initWithBattleInfo:(PP_BattleInfo *)battleInfo
{
    ...
    for (PP_BattlePet* battleMonster in [battleInfoData autoPets]) {
        ...
        CCLabelTTF* monsterNameLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"%@ LV%d", @"笨笨熊", monsterLevel] dimensions:CGSizeMake(200, 30) alignment:UITextAlignmentCenter fontName:@"Heiti SC" fontSize:13];
    ...
    for (PP_Pet* battlePet in [[[Global sharedGlobal] player] pets]) {
        if(battlePet.state == FIGHT){
            ...
            CCLabelTTF* petNameLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"%@ LV%d", [battlePet petName], petLevel] dimensions:CGSizeMake(200, 30) alignment:UITextAlignmentCenter fontName:@"Heiti SC" fontSize:13];
    ...
    readyCount = [CCLabelTTF labelWithString:@"30" dimensions:CGSizeMake(200, 30) alignment:UITextAlignmentCenter fontName:@"Heiti SC" fontSize:20];
