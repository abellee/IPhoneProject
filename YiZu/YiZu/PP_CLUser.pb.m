...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasTelephone) {
    [output writeInt64:14 value:self.telephone];
  }
  if (self.hasCoin) {
  ...
  if (self.hasAccTime) {
    [output writeMessage:25 value:self.accTime];
  }
  if (self.hasHomeLocation) {
    [output writeMessage:26 value:self.homeLocation];
  }
  if (self.hasLocation) {
    [output writeMessage:27 value:self.location];
  }
...
- (int32_t) serializedSize {
  ...
  if (self.hasBirthday) {
    size_ += computeInt32Size(10, self.birthday);
  }
  if (self.hasNation) {
  ...
  if (self.hasTelephone) {
    size_ += computeInt64Size(14, self.telephone);
  }
  if (self.hasCoin) {
  ...
  if (self.hasAccTime) {
    size_ += computeMessageSize(25, self.accTime);
  }
  if (self.hasHomeLocation) {
    size_ += computeMessageSize(26, self.homeLocation);
  }
  if (self.hasLocation) {
    size_ += computeMessageSize(27, self.location);
  }
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasBirthday) {
    [output appendFormat:@"%@%@: %@\n", indent, @"birthday", [NSNumber numberWithInt:self.birthday]];
  }
  if (self.hasNation) {
...
- (NSUInteger) hash {
  ...
  if (self.hasBirthday) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.birthday] hash];
  }
  if (self.hasNation) {
...
- (PP_CLUser_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 112: {
        [self setTelephone:[input readInt64]];
        break;
      }
      case 120: {
...
- (PP_CLUser_Builder*) setBirthday:(int32_t) value {
...
- (PP_CLUser_Builder*) setTelephone:(int64_t) value {
