...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[[Config instance] setSize:applicationFrame.size];
	
	movingTribal = [[MovingTribalController alloc] init];
	[movingTribal.view setFrame:applicationFrame];
	[self.window addSubview:movingTribal.view];
...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)devToken
{
	...
	NSURL *url = [[NSURL alloc] initWithScheme:@"http" host:[[Config instance] server] path:urlString];
