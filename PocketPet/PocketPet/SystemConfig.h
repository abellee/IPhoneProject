...
#ifndef YiZu_SystemConfig_h
#define YiZu_SystemConfig_h

#define SOCKET_SERVER   @"192.168.1.106"
#define SOCKET_PORT     5552

#define BASE_URL        @"http://192.168.1.106:8080"
...
#define USERVER_DATA_KEY   @"user_data_key"
#define USERNAME_KEY    @"username_key"
#define PASSWORD_KEY    @"password_key"
#define CHINESE_FONT    @"Verdana-Bold"
#define ENGLIST_FONT    @"Verdana-Bold"
#define NUMERIC_FONT    @"Verdana-Bold"
#define INFO_LEN        sizeof(int) * 7 + sizeof(float) * 2
