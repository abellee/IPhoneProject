...
+ (void) initialize {
  if (self == [PpPetRoot class]) {
    ...
    [PpPetEquipmentRoot registerAllExtensions:registry];
    [PpPetSkillRoot registerAllExtensions:registry];
...
@property int32_t attackLevel;
@property int32_t defenseLevel;
@property int32_t magicLevel;
@property int32_t magicDefenseLevel;
@property int32_t version;
@property int32_t mapId;
@property int32_t isBoss;
...
@synthesize petName;
- (BOOL) hasPetElement {
  return !!hasPetElement_;
}
- (void) setHasPetElement:(BOOL) value_ {
  hasPetElement_ = !!value_;
}
@synthesize petElement;
- (BOOL) hasLevel {
  return !!hasLevel_;
}
...
@synthesize tid;
- (BOOL) hasAttackLevel {
  return !!hasAttackLevel_;
}
- (void) setHasAttackLevel:(BOOL) value_ {
  hasAttackLevel_ = !!value_;
}
@synthesize attackLevel;
- (BOOL) hasDefenseLevel {
  return !!hasDefenseLevel_;
}
- (void) setHasDefenseLevel:(BOOL) value_ {
  hasDefenseLevel_ = !!value_;
}
@synthesize defenseLevel;
- (BOOL) hasMagicLevel {
  return !!hasMagicLevel_;
}
- (void) setHasMagicLevel:(BOOL) value_ {
  hasMagicLevel_ = !!value_;
}
@synthesize magicLevel;
- (BOOL) hasMagicDefenseLevel {
  return !!hasMagicDefenseLevel_;
}
- (void) setHasMagicDefenseLevel:(BOOL) value_ {
  hasMagicDefenseLevel_ = !!value_;
}
@synthesize magicDefenseLevel;
- (BOOL) hasVersion {
  return !!hasVersion_;
}
...
- (void) setHasIsNpc:(BOOL) value_ {
  hasIsNpc_ = !!value_;
}
@synthesize isNpc;
- (BOOL) hasLastEquipVersionId {
  return !!hasLastEquipVersionId_;
}
- (void) setHasLastEquipVersionId:(BOOL) value_ {
  hasLastEquipVersionId_ = !!value_;
}
@synthesize lastEquipVersionId;
- (BOOL) hasLastSkillVersionId {
  return !!hasLastSkillVersionId_;
}
- (void) setHasLastSkillVersionId:(BOOL) value_ {
...
- (PP_Pet_Equipment*)equipmentsAtIndex:(NSUInteger)index {
  return [equipmentsArray objectAtIndex:index];
}
- (PBArray *)skills {
  return skillsArray;
}
- (PP_Pet_Skill*)skillsAtIndex:(NSUInteger)index {
  return [skillsArray objectAtIndex:index];
}
- (BOOL) isInitialized {
  return YES;
}
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
  ...
  if (self.hasPetElement) {
    [output writeInt32:4 value:self.petElement];
  }
  if (self.hasLevel) {
    [output writeInt32:5 value:self.level];
  }
  if (self.hasCurExp) {
    [output writeInt32:6 value:self.curExp];
  }
  if (self.hasTotalExp) {
    [output writeInt32:7 value:self.totalExp];
  }
  if (self.hasCurHp) {
    [output writeInt32:8 value:self.curHp];
  }
  if (self.hasTotalHp) {
    [output writeInt32:9 value:self.totalHp];
  }
  if (self.hasCurMp) {
    [output writeInt32:10 value:self.curMp];
  }
  if (self.hasTotalMp) {
    [output writeInt32:11 value:self.totalMp];
  }
  if (self.hasState) {
    [output writeInt32:12 value:self.state];
  }
  if (self.hasLife) {
    [output writeInt32:13 value:self.life];
  }
  if (self.hasGrow) {
    [output writeInt32:14 value:self.grow];
  }
  if (self.hasFeel) {
    [output writeInt32:15 value:self.feel];
  }
  if (self.hasAge) {
    [output writeInt32:16 value:self.age];
  }
  if (self.hasIsVariation) {
    [output writeInt32:17 value:self.isVariation];
  }
  if (self.hasVariationLevel) {
    [output writeInt32:18 value:self.variationLevel];
  }
  if (self.hasPower) {
    [output writeInt32:19 value:self.power];
  }
  if (self.hasAgile) {
    [output writeInt32:20 value:self.agile];
  }
  if (self.hasIntellegence) {
    [output writeInt32:21 value:self.intellegence];
  }
  if (self.hasVigour) {
    [output writeInt32:22 value:self.vigour];
  }
  if (self.hasEndur) {
    [output writeInt32:23 value:self.endur];
  }
  if (self.hasAttack) {
    [output writeInt32:24 value:self.attack];
  }
  if (self.hasDefense) {
    [output writeInt32:25 value:self.defense];
  }
  if (self.hasMagicDamage) {
    [output writeInt32:26 value:self.magicDamage];
  }
  if (self.hasMagicDefense) {
    [output writeInt32:27 value:self.magicDefense];
  }
  if (self.hasTid) {
    [output writeInt32:28 value:self.tid];
  }
  if (self.hasAttackLevel) {
    [output writeInt32:29 value:self.attackLevel];
  }
  if (self.hasDefenseLevel) {
    [output writeInt32:30 value:self.defenseLevel];
  }
  if (self.hasMagicLevel) {
    [output writeInt32:31 value:self.magicLevel];
  }
  if (self.hasMagicDefenseLevel) {
    [output writeInt32:32 value:self.magicDefenseLevel];
  }
  if (self.hasVersion) {
    [output writeInt32:33 value:self.version];
  }
  if (self.hasMapId) {
    [output writeInt32:34 value:self.mapId];
  }
  if (self.hasIsBoss) {
    [output writeInt32:35 value:self.isBoss];
  }
  if (self.hasIsNpc) {
    [output writeInt32:36 value:self.isNpc];
  }
  if (self.hasLastEquipVersionId) {
    [output writeInt32:37 value:self.lastEquipVersionId];
  }
...
- (int32_t) serializedSize {
  ...
  if (self.hasPetElement) {
    size_ += computeInt32Size(4, self.petElement);
  }
  if (self.hasLevel) {
    size_ += computeInt32Size(5, self.level);
  }
  if (self.hasCurExp) {
    size_ += computeInt32Size(6, self.curExp);
  }
  if (self.hasTotalExp) {
    size_ += computeInt32Size(7, self.totalExp);
  }
  if (self.hasCurHp) {
    size_ += computeInt32Size(8, self.curHp);
  }
  if (self.hasTotalHp) {
    size_ += computeInt32Size(9, self.totalHp);
  }
  if (self.hasCurMp) {
    size_ += computeInt32Size(10, self.curMp);
  }
  if (self.hasTotalMp) {
    size_ += computeInt32Size(11, self.totalMp);
  }
  if (self.hasState) {
    size_ += computeInt32Size(12, self.state);
  }
  if (self.hasLife) {
    size_ += computeInt32Size(13, self.life);
  }
  if (self.hasGrow) {
    size_ += computeInt32Size(14, self.grow);
  }
  if (self.hasFeel) {
    size_ += computeInt32Size(15, self.feel);
  }
  if (self.hasAge) {
    size_ += computeInt32Size(16, self.age);
  }
  if (self.hasIsVariation) {
    size_ += computeInt32Size(17, self.isVariation);
  }
  if (self.hasVariationLevel) {
    size_ += computeInt32Size(18, self.variationLevel);
  }
  if (self.hasPower) {
    size_ += computeInt32Size(19, self.power);
  }
  if (self.hasAgile) {
    size_ += computeInt32Size(20, self.agile);
  }
  if (self.hasIntellegence) {
    size_ += computeInt32Size(21, self.intellegence);
  }
  if (self.hasVigour) {
    size_ += computeInt32Size(22, self.vigour);
  }
  if (self.hasEndur) {
    size_ += computeInt32Size(23, self.endur);
  }
  if (self.hasAttack) {
    size_ += computeInt32Size(24, self.attack);
  }
  if (self.hasDefense) {
    size_ += computeInt32Size(25, self.defense);
  }
  if (self.hasMagicDamage) {
    size_ += computeInt32Size(26, self.magicDamage);
  }
  if (self.hasMagicDefense) {
    size_ += computeInt32Size(27, self.magicDefense);
  }
  if (self.hasTid) {
    size_ += computeInt32Size(28, self.tid);
  }
  if (self.hasAttackLevel) {
    size_ += computeInt32Size(29, self.attackLevel);
  }
  if (self.hasDefenseLevel) {
    size_ += computeInt32Size(30, self.defenseLevel);
  }
  if (self.hasMagicLevel) {
    size_ += computeInt32Size(31, self.magicLevel);
  }
  if (self.hasMagicDefenseLevel) {
    size_ += computeInt32Size(32, self.magicDefenseLevel);
  }
  if (self.hasVersion) {
    size_ += computeInt32Size(33, self.version);
  }
  if (self.hasMapId) {
    size_ += computeInt32Size(34, self.mapId);
  }
  if (self.hasIsBoss) {
    size_ += computeInt32Size(35, self.isBoss);
  }
  if (self.hasIsNpc) {
    size_ += computeInt32Size(36, self.isNpc);
  }
  if (self.hasLastEquipVersionId) {
    size_ += computeInt32Size(37, self.lastEquipVersionId);
  }
  if (self.hasLastSkillVersionId) {
...
- (void) writeDescriptionTo:(NSMutableString*) output withIndent:(NSString*) indent {
  ...
  if (self.hasPetElement) {
    [output appendFormat:@"%@%@: %@\n", indent, @"petElement", [NSNumber numberWithInt:self.petElement]];
  }
  if (self.hasLevel) {
  ...
  if (self.hasAttackLevel) {
    [output appendFormat:@"%@%@: %@\n", indent, @"attackLevel", [NSNumber numberWithInt:self.attackLevel]];
  }
  if (self.hasDefenseLevel) {
    [output appendFormat:@"%@%@: %@\n", indent, @"defenseLevel", [NSNumber numberWithInt:self.defenseLevel]];
  }
  if (self.hasMagicLevel) {
    [output appendFormat:@"%@%@: %@\n", indent, @"magicLevel", [NSNumber numberWithInt:self.magicLevel]];
  }
  if (self.hasMagicDefenseLevel) {
    [output appendFormat:@"%@%@: %@\n", indent, @"magicDefenseLevel", [NSNumber numberWithInt:self.magicDefenseLevel]];
  }
  if (self.hasVersion) {
  ...
  if (self.hasIsBoss) {
    [output appendFormat:@"%@%@: %@\n", indent, @"isBoss", [NSNumber numberWithInt:self.isBoss]];
  }
  if (self.hasIsNpc) {
    [output appendFormat:@"%@%@: %@\n", indent, @"isNpc", [NSNumber numberWithInt:self.isNpc]];
  }
  if (self.hasLastEquipVersionId) {
    [output appendFormat:@"%@%@: %@\n", indent, @"lastEquipVersionId", [NSNumber numberWithInt:self.lastEquipVersionId]];
  }
  if (self.hasLastSkillVersionId) {
...
- (BOOL) isEqual:(id)other {
  ...
  return
      ...
      self.hasPetElement == otherMessage.hasPetElement &&
      (!self.hasPetElement || self.petElement == otherMessage.petElement) &&
      ...
      self.hasAttackLevel == otherMessage.hasAttackLevel &&
      (!self.hasAttackLevel || self.attackLevel == otherMessage.attackLevel) &&
      self.hasDefenseLevel == otherMessage.hasDefenseLevel &&
      (!self.hasDefenseLevel || self.defenseLevel == otherMessage.defenseLevel) &&
      self.hasMagicLevel == otherMessage.hasMagicLevel &&
      (!self.hasMagicLevel || self.magicLevel == otherMessage.magicLevel) &&
      self.hasMagicDefenseLevel == otherMessage.hasMagicDefenseLevel &&
      (!self.hasMagicDefenseLevel || self.magicDefenseLevel == otherMessage.magicDefenseLevel) &&
      ...
      self.hasIsBoss == otherMessage.hasIsBoss &&
      (!self.hasIsBoss || self.isBoss == otherMessage.isBoss) &&
      self.hasIsNpc == otherMessage.hasIsNpc &&
      (!self.hasIsNpc || self.isNpc == otherMessage.isNpc) &&
      self.hasLastEquipVersionId == otherMessage.hasLastEquipVersionId &&
...
- (NSUInteger) hash {
  ...
  if (self.hasPetElement) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.petElement] hash];
  }
  if (self.hasLevel) {
  ...
  if (self.hasAttackLevel) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.attackLevel] hash];
  }
  if (self.hasDefenseLevel) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.defenseLevel] hash];
  }
  if (self.hasMagicLevel) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.magicLevel] hash];
  }
  if (self.hasMagicDefenseLevel) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.magicDefenseLevel] hash];
  }
  if (self.hasVersion) {
  ...
  if (self.hasIsBoss) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.isBoss] hash];
  }
  if (self.hasIsNpc) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.isNpc] hash];
  }
  if (self.hasLastEquipVersionId) {
    hashCode = hashCode * 31 + [[NSNumber numberWithInt:self.lastEquipVersionId] hash];
  }
  if (self.hasLastSkillVersionId) {
...
- (PP_Pet_Builder*) mergeFrom:(PP_Pet*) other {
  ...
  if (other.hasPetElement) {
    [self setPetElement:other.petElement];
  }
  if (other.hasLevel) {
  ...
  if (other.hasAttackLevel) {
    [self setAttackLevel:other.attackLevel];
  }
  if (other.hasDefenseLevel) {
    [self setDefenseLevel:other.defenseLevel];
  }
  if (other.hasMagicLevel) {
    [self setMagicLevel:other.magicLevel];
  }
  if (other.hasMagicDefenseLevel) {
    [self setMagicDefenseLevel:other.magicDefenseLevel];
  }
  if (other.hasVersion) {
  ...
  if (other.hasIsNpc) {
    [self setIsNpc:other.isNpc];
  }
  if (other.hasLastEquipVersionId) {
    [self setLastEquipVersionId:other.lastEquipVersionId];
  }
  ...
  if (other.equipmentsArray.count > 0) {
    if (result.equipmentsArray == nil) {
      result.equipmentsArray = [[other.equipmentsArray copyWithZone:[other.equipmentsArray zone]] autorelease];
    } else {
      [result.equipmentsArray appendArray:other.equipmentsArray];
    }
  }
  if (other.skillsArray.count > 0) {
    if (result.skillsArray == nil) {
      result.skillsArray = [[other.skillsArray copyWithZone:[other.skillsArray zone]] autorelease];
    } else {
      [result.skillsArray appendArray:other.skillsArray];
    }
  }
...
- (PP_Pet_Builder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
  ...
  while (YES) {
    ...
    switch (tag) {
      ...
      case 32: {
        [self setPetElement:[input readInt32]];
        break;
      }
      case 40: {
      ...
      case 232: {
        [self setAttackLevel:[input readInt32]];
        break;
      }
      case 240: {
        [self setDefenseLevel:[input readInt32]];
        break;
      }
      case 248: {
        [self setMagicLevel:[input readInt32]];
        break;
      }
      case 256: {
        [self setMagicDefenseLevel:[input readInt32]];
        break;
      }
      case 264: {
      ...
      case 280: {
        [self setIsBoss:[input readInt32]];
        break;
      }
      case 288: {
        [self setIsNpc:[input readInt32]];
        break;
      }
      case 296: {
        [self setLastEquipVersionId:[input readInt32]];
        break;
      }
      case 304: {
...
- (BOOL) hasPetElement {
  return result.hasPetElement;
}
- (int32_t) petElement {
  return result.petElement;
}
- (PP_Pet_Builder*) setPetElement:(int32_t) value {
  result.hasPetElement = YES;
  result.petElement = value;
  return self;
}
- (PP_Pet_Builder*) clearPetElement {
  result.hasPetElement = NO;
  result.petElement = 0;
  return self;
}
- (BOOL) hasLevel {
...
- (BOOL) hasAttackLevel {
  return result.hasAttackLevel;
}
- (int32_t) attackLevel {
  return result.attackLevel;
}
- (PP_Pet_Builder*) setAttackLevel:(int32_t) value {
  result.hasAttackLevel = YES;
  result.attackLevel = value;
  return self;
}
- (PP_Pet_Builder*) clearAttackLevel {
  result.hasAttackLevel = NO;
  result.attackLevel = 0;
  return self;
}
- (BOOL) hasDefenseLevel {
  return result.hasDefenseLevel;
}
- (int32_t) defenseLevel {
  return result.defenseLevel;
}
- (PP_Pet_Builder*) setDefenseLevel:(int32_t) value {
  result.hasDefenseLevel = YES;
  result.defenseLevel = value;
  return self;
}
- (PP_Pet_Builder*) clearDefenseLevel {
  result.hasDefenseLevel = NO;
  result.defenseLevel = 0;
  return self;
}
- (BOOL) hasMagicLevel {
  return result.hasMagicLevel;
}
- (int32_t) magicLevel {
  return result.magicLevel;
}
- (PP_Pet_Builder*) setMagicLevel:(int32_t) value {
  result.hasMagicLevel = YES;
  result.magicLevel = value;
  return self;
}
- (PP_Pet_Builder*) clearMagicLevel {
  result.hasMagicLevel = NO;
  result.magicLevel = 0;
  return self;
}
- (BOOL) hasMagicDefenseLevel {
  return result.hasMagicDefenseLevel;
}
- (int32_t) magicDefenseLevel {
  return result.magicDefenseLevel;
}
- (PP_Pet_Builder*) setMagicDefenseLevel:(int32_t) value {
  result.hasMagicDefenseLevel = YES;
  result.magicDefenseLevel = value;
  return self;
}
- (PP_Pet_Builder*) clearMagicDefenseLevel {
  result.hasMagicDefenseLevel = NO;
  result.magicDefenseLevel = 0;
  return self;
}
- (BOOL) hasVersion {
...
- (BOOL) hasLastEquipVersionId {
  return result.hasLastEquipVersionId;
}
- (int32_t) lastEquipVersionId {
  return result.lastEquipVersionId;
}
- (PP_Pet_Builder*) setLastEquipVersionId:(int32_t) value {
  result.hasLastEquipVersionId = YES;
  result.lastEquipVersionId = value;
  return self;
}
- (PP_Pet_Builder*) clearLastEquipVersionId {
  result.hasLastEquipVersionId = NO;
  result.lastEquipVersionId = 0;
  return self;
}
- (BOOL) hasLastSkillVersionId {
  return result.hasLastSkillVersionId;
}
- (int32_t) lastSkillVersionId {
  return result.lastSkillVersionId;
}
- (PP_Pet_Builder*) setLastSkillVersionId:(int32_t) value {
  result.hasLastSkillVersionId = YES;
  result.lastSkillVersionId = value;
  return self;
}
...
- (PBAppendableArray *)equipments {
  return result.equipmentsArray;
}
- (PP_Pet_Equipment*)equipmentsAtIndex:(NSUInteger)index {
  return [result equipmentsAtIndex:index];
}
- (PP_Pet_Builder *)addEquipments:(PP_Pet_Equipment*)value {
  if (result.equipmentsArray == nil) {
    result.equipmentsArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeObject];
  }
  [result.equipmentsArray addObject:value];
  return self;
}
- (PP_Pet_Builder *)setEquipmentsArray:(NSArray *)array {
  result.equipmentsArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeObject];
  return self;
}
- (PP_Pet_Builder *)setEquipmentsValues:(const PP_Pet_Equipment* *)values count:(NSUInteger)count {
  result.equipmentsArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeObject];
  return self;
}
- (PP_Pet_Builder *)clearEquipments {
  result.equipmentsArray = nil;
  return self;
}
- (PBAppendableArray *)skills {
  return result.skillsArray;
}
- (PP_Pet_Skill*)skillsAtIndex:(NSUInteger)index {
...
- (PP_Pet_Builder *)addSkills:(PP_Pet_Skill*)value {
  if (result.skillsArray == nil) {
    result.skillsArray = [PBAppendableArray arrayWithValueType:PBArrayValueTypeObject];
  }
  [result.skillsArray addObject:value];
  return self;
}
- (PP_Pet_Builder *)setSkillsArray:(NSArray *)array {
  result.skillsArray = [PBAppendableArray arrayWithArray:array valueType:PBArrayValueTypeObject];
  return self;
}
- (PP_Pet_Builder *)setSkillsValues:(const PP_Pet_Skill* *)values count:(NSUInteger)count {
  result.skillsArray = [PBAppendableArray arrayWithValues:values count:count valueType:PBArrayValueTypeObject];
  return self;
}
- (PP_Pet_Builder *)clearSkills {
  result.skillsArray = nil;
  return self;
}
@end
